...
public class Vect {
    ...
    public static Vect getVect(Vect from,Vect to){
        return new Vect(to.getX()-from.getX(),to.getY()-from.getY());
    }
    public double getSize(){
        return Math.sqrt(x*x+y*y);
    }
    public static double getAngle(Vect in,Vect out){
        return Math.asin((in.getX()*out.getY()-in.getY()*out.getX())/(in.getSize()*out.getSize()));
    }
